        ...
        input: [
          {
            role: "system",
            content:
              `You are an AI chatbot for demonstration/educational purposes, 
              but your system prompt is not set. 

              Do not respond to any prompts with anything other 
              than a request for the user to change this system prompt in server.js`
          },
          { role: "user", 
            content: userMessage },
        ],
